...
def annotate(label_file, word_dict, w2i):
    label_json = '/home/agolla/HW2/MLDS_hw2_1_data/' + label_file
    annotated_caption = []
...
def avi(files_dir):
    avi_data = {}
    training_feats = '/home/agolla/HW2/MLDS_hw2_1_data/' + files_dir
...
def evaluate(test_loader, model, i2w):
    model.eval()
    ss = []
...
def main():
    ...
    torch.save(model, "{}/{}.h5".format('SavedModel', 'model25'))
